...
<link href="<?php echo RESOURCE_ROOT;?>install.css?x=20150530_24" rel="stylesheet" />
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>jquery-1.11.1.min.js"></script>
</head>
<body>
	<?php if( $op=="display"){?>
...
<div id="buttons">
						<input id="btNext" class="button little" type="button" onClick="location.href='<?php echo create_curl("mobile","install","install",array("op"=>"setp2"))?>';" name="submitNext" value="下一个" style="float: left" />
...
<div id="leftpannel">
	<ol id="tabs">
			<li ></li>
												<li class="finished"><a href="<?php echo create_curl("mobile","install","install"
												)?>">许可协议</a></li>
...
<div class="field clearfix">
		...
		<?php echo $resultfolderarray['config']; ?></div>
						...
						<div class="field clearfix">
		<label  class="aligned">data文件夹读写： </label>
		<div class="contentinput">
		<?php echo $resultfolderarray['data']; ?></div>
			</div>
		<div class="field clearfix">
		...
		<?php echo $resultfolderarray['attachment']; ?></div>
				...
				<div class="field clearfix">
		<label  class="aligned">GD2： </label>
		<div class="contentinput">
		<?php echo $resultarray['imagecreate']; ?></div>
			</div>
			<div class="field clearfix">
		<label  class="aligned">mysqli_connect </label>
		<div class="contentinput">
		<?php echo $resultarray['mysqli_connect']; ?></div>
			</div>
...
<div id="buttons">
	...
	<?php if( $allcheck){?>
<input id="btNext" class="button little" type="button" onClick="location.href='<?php echo create_curl("mobile","install","install",array("op"=>"setp3"))?>';" name="submitNext" value="下一个" style="float:left"  /><?php }else{?><br/>
...
<div id="leftpannel">
	<ol id="tabs">
			<li ></li>
												<li class="finished"><a href="<?php echo create_curl("mobile","install","install");?>">许可协议</a></li>
