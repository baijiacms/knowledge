...
<title>跳转提示</title>
<link href="<?php echo RESOURCE_COMMON;?>weui.min.css" rel="stylesheet">
<link href="<?php echo RESOURCE_COMMON;?>weui.plus.css?v=2" rel="stylesheet">
</head>
<body>
	...
	?>
        ...
        <div class="weui-msg__extra-area">
            <div class="weui-footer">
                ...
                <p class="weui-footer__text">Copyright © 2018 baijiacms.com</p>
            </div>
        </div>
    </div>
</div>
